...
import Contract.Monad (ContractConfig(ContractConfig), liftedE, liftedM, liftContractM, runContract, traceContractConfig)
...
threeRedeemerContract = do 
  ...
  runContract (ContractConfig $ defaults { wallet = pure wallet}) $ do 
    ...
    let
      ...
      constraints = mconcat $ Constraints.mustPayToScript vhash unitDatum <<< lovelaceValueOf <<< fromInt <$> [2_000_000, 3_000_000, 4_000_000]
