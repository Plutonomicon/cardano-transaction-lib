...
enterpriseAddressFunctionsTest = do
  pkh <- errMaybe "Error ed25519KeyHashFromBech32:" mPkh
...
pointerAddressFunctionsTest = do
  pkh <- errMaybe "Error ed25519KeyHashFromBech32:" mPkh
