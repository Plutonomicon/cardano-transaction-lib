...
import Ctl.Internal.Plutip.Spawn (ManagedProcess, NewOutputAction(..), spawn)
import Ctl.Internal.QueryM (ClientError(..), handleAffjaxResponse, mkHttpUrl, postAeson, scriptToAeson)
...
applyArgsAux script args = withCtlServer serverConfig $
  ...
  withCtlServer config a = bracket
