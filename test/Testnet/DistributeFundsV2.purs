module Test.Ctl.Testnet.DistributeFundsV2
  ( suite
  ) where
...
import Ctl.Internal.Testnet.DistributeFundsV2
  ( AssignUtxoResult
  ...
  group "DistributeFundsV2" do
    ...
    group "runDistrFundsRound" do
      test "Fails if utxo cannot be covered by any source"
        ...
        in
          runDistrFundsRound defaultParams sources utxos `shouldEqual`
