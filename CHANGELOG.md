...
- `Contract.Test.Plutip.testPlutipContracts` to run multiple Plutip tests under the same Plutip instance ([#1154](https://github.com/Plutonomicon/cardano-transaction-lib/pull/1154)).
