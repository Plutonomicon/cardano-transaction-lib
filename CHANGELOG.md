...
- Added cip30 methods : `getNetworkId` `getChangeAddress` `getRewardAddresses` `getUnusedAddresses` to `Contract.Wallet` ([#974](https://github.com/Plutonomicon/cardano-transaction-lib/issues/974))
