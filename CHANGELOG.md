...
- Error message from `reconnecting-websocket` is passed correctly in `Ctl.Internal.JsWebSocket._onWsError` ([#1403](https://github.com/Plutonomicon/cardano-transaction-lib/pull/1403))
