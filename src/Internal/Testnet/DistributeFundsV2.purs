module Ctl.Internal.Testnet.DistributeFundsV2 where
...
data DistrFundsError
  = DistrFunds_MaxUtxosPerTxLowerLimitError
  | DistrFunds_AssignUtxoError
  | DistrFunds_MaxRoundsExceededError

derive instance Generic DistrFundsError _
derive instance Eq DistrFundsError

instance Show DistrFundsError where
  show = genericShow
...
makeDistributionPlan
  ...
  -> Array (wallet /\ amount)
  -> Array (wallet /\ amount)
  -> Either DistrFundsError (Array (Array (Tx wallet amount)))
...
runDistrFundsRound
  ...
  -> List (wallet /\ amount)
  -> Either DistrFundsError (DistrFundsRoundResult wallet amount)
