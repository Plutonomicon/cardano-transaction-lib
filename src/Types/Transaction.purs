...
newtype TxBody = TxBody
  ...
  , certs :: Maybe Unit
  , -- Certificates,
    withdrawals :: Maybe Unit
  , -- Withdrawals,
    update :: Maybe Unit
  , -- Update,
    auxiliary_data_hash :: Maybe String
  , -- AuxiliaryDataHash, - script hashes
    validity_start_interval :: Maybe Slot
  , mint :: Maybe Value
  , -- Mint
    script_data_hash :: Maybe String
  , -- ScriptDataHash,
...
newtype TransactionWitnessSet = TransactionWitnessSet
  ...
  , native_scripts :: Maybe Unit
  , -- NativeScripts,
    bootstraps :: Maybe Unit
  , -- BootstrapWitnesses,
...
newtype Redeemer = Redeemer
  { tag :: RedeemerTag
  , -- ScriptPurpose: 'spending' 'minting' etc
    index :: BigInt.BigInt
  , data :: PlutusData
